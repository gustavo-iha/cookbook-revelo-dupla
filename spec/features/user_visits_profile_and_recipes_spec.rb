...
feature 'User' do
  ...
  scenario 'sees only his recipes' do
    ...
    user_2 = User.create(email: 'gustavo2@gmail.com', password: '1234567')
    ...
    cook_time: 60,
    ingredients: 'Farinha, açucar, cenoura',
    cook_method: 'Cozinhe o chocolate, corte em pedaços pequenos, misture com o restante dos ingredientes', user: user_2)
